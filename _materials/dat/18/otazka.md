...
RazorPages, GET a POST požadavky, bindování dat, návratové metody (Redirect, View), routování, pretty URL
...
1. Na stránce `/Register`:
   ...
   - Umožněte naplnit formulářový prvek na základě parametru předaného stránce (například email).
