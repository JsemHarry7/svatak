# DAT 10 — Podprogramy a lambda funkce
...
> **Souvisí s:** SWI 2 (algoritmus — rekurze jako typ algoritmu), SWI 9 (OOP — metody jako součást třídy), DAT 11 (kolekce — LINQ s lambda), DAT 13 (paralelní — async lambda)
