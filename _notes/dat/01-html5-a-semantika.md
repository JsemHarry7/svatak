...
> **Cíl:** umět o tématu mluvit 10–15 min s komisí, zvládnout 30 min praktickou úlohu (napsat sémantickou strukturu stránky z prázdného souboru).
> **Předmět:** DAT / okruh **ZAL** (základy)
> **Souvisí s:** **SWI 15** (webová stránka — teoretický overlap), DAT 2–7 (CSS a layouty staví na HTML), SWI 13 (Internet — kontext webu)
