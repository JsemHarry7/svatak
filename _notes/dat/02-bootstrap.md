# DAT 2 — Bootstrap a návrh designu

> **Cíl:** umět o tématu mluvit 10–15 min s komisí, zvládnout 30+ min praktickou úlohu (full responzivní web s navbar, gridem, kartami, footerem).
> **Předmět:** DAT / okruh **WEB**
> **Souvisí s:** DAT 1 (HTML5), DAT 3 (Flexbox — Bootstrap interně používá), DAT 4 (Grid), DAT 5 (pozicování), SWI 14 (návrh webu — responzivita), SWI 16/17 (CSS)
