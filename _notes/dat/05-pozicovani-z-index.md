# DAT 5 — Pozicování prvků a z-index

> **Cíl:** umět o tématu mluvit 10–15 min s komisí, zvládnout 30 min praktickou úlohu (sticky header + float + relative/absolute karta + fixed modal).
> **Předmět:** DAT / okruh **WEB**
> **Souvisí s:** DAT 3 (Flexbox), DAT 4 (Grid) — pozicování je **třetí cesta** layoutu vedle těchto dvou, ale historicky starší. SWI 16 (kaskáda), SWI 17 (vlastnosti CSS).
