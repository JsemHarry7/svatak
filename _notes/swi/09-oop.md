# SWI 9 — Objektové programování

> **Cíl:** umět o tématu mluvit 10–15 min souvisle, k tomu odpovědět na 3–5 follow-up otázek komise.
> **Předmět:** SWI / okruh **PRG** (programování)
> **Souvisí s:** **DAT 11** (kolekce — `List<T>`, `Dictionary<K,V>` jsou OOP s generikou), DAT 22 (React komponenty — analogie tříd ve funkcionálním stylu), DAT 17/18 (ASP.NET — controllery jsou třídy), SWI 5 (návrhové vzory — postaveny na OOP), SWI 4 (datové typy — value × reference)
