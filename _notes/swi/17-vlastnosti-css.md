...
> **Souvisí s:** **SWI 16** (kaskáda — vlastnosti se aplikují přes selektory), DAT 1 (HTML, na který se vlastnosti vážou), DAT 3/4 (Flexbox/Grid — používají typografické a velikostní vlastnosti), DAT 6 (animace transformují vlastnosti)
