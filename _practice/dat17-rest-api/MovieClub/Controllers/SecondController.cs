...
public class SecondController : Controller
{
    ...
    public async Task<IActionResult> Create([Bind("MovieId,Title,Year,Genre,AddedBy,Votes,IsWatched,AddedAt")] Movie movie)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int? movieid, [Bind("MovieId,Title,Year,Genre,AddedBy,Votes,IsWatched,AddedAt")] Movie movie)
    {
